...
$(function () {
            ...
            if (el.fCircuitid == id) {
                ...
                getDataByAjax(cirMaiUrl, {
                    ...
                    if (valueInfo.paramMap) {
                        $("#Ia").html(
                            valueInfo.paramMap.Ia === undefined ? "-" : valueInfo.paramMap.Ia
                        );
                        $("#Ib").html(
                            valueInfo.paramMap.Ib === undefined ? "-" : valueInfo.paramMap.Ib
                        );
                        $("#Ic").html(
                            valueInfo.paramMap.Ic === undefined ? "-" : valueInfo.paramMap.Ic
                        );
                        // 电压
                        $("#Ua").html(
                            valueInfo.paramMap.Ua === undefined ? "-" : valueInfo.paramMap.Ua
                        );
                        $("#Ub").html(
                            valueInfo.paramMap.Ub === undefined ? "-" : valueInfo.paramMap.Ub
                        );
                        $("#Uc").html(
                            valueInfo.paramMap.Uc === undefined ? "-" : valueInfo.paramMap.Uc
                        );
                        // 相电压
                        $("#Uab").html(
    ...
    $("#subList").change(function (event) {
        var fCuiID = $(this).find("option:selected").attr('name');
        fCircuitid = fCuiID;
