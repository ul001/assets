...
(function (name, definition) {
  ...
  MeScroll.prototype.extendDownScroll = function (optDown) {
    ...
    MeScroll.extend(optDown, {
      ...
      textInOffset: Operation['ui_downupdate'], // 下拉的距离在offset范围内的提示文本
      textOutOffset: Operation['ui_freedupdate'], // 下拉的距离大于offset范围的提示文本
      textLoading: Operation['ui_loading'], // 加载中的提示文本
  ...
  MeScroll.prototype.extendUpScroll = function (optUp) {
    ...
    MeScroll.extend(optUp, {
      ...
      htmlLoading: '<p class="upwarp-progress mescroll-rotate"></p><p class="upwarp-tip">'+Operation['ui_loading']+'</p>', // 上拉加载中的布局
