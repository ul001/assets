$(function () {
    ...
    function showTable(data) {
        ...
        $.each(data.TransCircuitEnergyValue, function (key, val) {
            ...
            rowLengthArr.push({
                length: val.circuits.length + 3,
                rowIndex: currentCircuitsLength
            });
            ...
            tableRows.push({
                transformer: val.fTransname,
                typeName: outTypeName,
                meterName: '',
                value: outValue.toFixed(2)
            });
            tableRows.push({
                transformer: val.fTransname,
                typeName: diffType,
                meterName: '',
                value: (inValue - outValue).toFixed(2)
            });
            if (inValue === 0 || inValue === 0.00) {
                ...
                tableRows.push({
                    ...
                    typeName: lossType,
                    meterName: '',
                    value: ((inValue - outValue) / inValue * 100).toFixed(2) + "%"
                });
            }
        });
