...
function getZhLanguage() {
  Operation = {
    ...
    ui_InPa: "内部气压",
    ui_Vibration: "振动",
    ui_WaterLevelMonitor: "水位监测",
    ui_WaterLevel: "水位",
    ui_gasMonitor: "SF₆气体监测",
    ui_Dust: "粉尘",
    ui_nowpower: "视在",
    ui_haspower: "有功",
    ui_nopower: "无功",
    ...
    ui_min: "分",
    //直流屏
    ui_Avoltage1: "交流1路A相电压",
    ui_Bvoltage1: "交流1路B相电压",
    ui_Cvoltage1: "交流1路C相电压",
    ui_Avoltage2: "交流2路A相电压",
    ui_Bvoltage2: "交流2路B相电压",
    ui_Cvoltage2: "交流2路C相电压",
    ui_DCSPowerOnU: "合母电压",
    ui_DCSPowerOffU: "控母电压",
    ui_DCSum: "电池总电流",
    ui_DCSPowerOffI: "控母电流",
    ui_DCplanStatus: "直流屏状态",
    ui_yaoce: "遥测",
    ui_selsectAvolt1: "交流一路相电压",
    ui_selsectAvolt2: "交流二路相电压",
...
function getEnLanguage() {
  Operation = {
    ...
    ui_pf: "Power Factor",
    ui_demand: "Demand",
    ui_IUnbalance: "IUnbalance",
    ui_UUnbalance: "UUnbalance",
    ui_IL: "Residual current",
    ui_EPIEQL: "Forward Electricity",
    ui_EPEEQC: "Reverse power",
    ui_MathVal: "Value",
    ui_dayreport: "Daily",
    ...
    ui_rateminusval: "RateDifference",
    ...
    ui_noise: "Noise",
    ui_other: "Other",
    ui_Nitrogen: "Nitrogen",
    ui_Olevel: "Olevel",
    ui_InPa: "InPa",
    ui_Dust: "Dust",
    ui_Vibration: "Vibration",
    ui_WaterLevelMonitor: "WaterLevelMonitor",
    ui_WaterLevel: "Level",
    ui_gasMonitor: "SF₆GasMonitor",
    ui_nowpower: "S",
    ui_haspower: "P",
    ui_nopower: "Q",
    ui_tempLine: "Temp",
    ui_tempOilLine: "OilTemp",
